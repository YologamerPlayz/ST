...
public class ClientMessageTechnicianScreen extends JPanel {
    ...
    public ClientMessageTechnicianScreen(MainApp mainApp, int technicianId) {
        this.mainApp = mainApp;
        this.technicianId = technicianId;
        this.clientId = mainApp.getCurrentUserId();
        ...
        backBtn.addActionListener(e -> mainApp.switchScreen(new TechnicianContactScreen(mainApp, technicianId)));

        JLabel title = new JLabel("Chat with Technician", SwingConstants.CENTER);
